...
export const QRITTER_ASPECTS = {
  ...
  ENDEW: {
    ...
    singular: 'Endew',
    plural: 'Endui',
    description: `Endui embody the essence of water, dew, and moisture in all its forms. I've encountered them near mist-covered meadows, foggy shorelines, and early morning dewdrops. A single Endew can blend into its environment, almost disappearing into the water-laden air.`,
  },
  IGNOLITH: {
    id: 'ignolith',
    singular: 'Ignolith',
